...
Release `r001` is the frozen production firmware release for the initial shipping batch. Later firmware changes should be retained under a new release folder such as `releases/r002/`.
